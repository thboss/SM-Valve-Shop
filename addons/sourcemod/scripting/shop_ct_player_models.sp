...
#define CATEGORY	"ct_player_models"
...
{
	name = "[SHOP] Counter-Terrorist models",
	author = "FrozDark Feat R1KO, Tonki_Ton, TheBO$$)",
	description = "Valve CT Player Models",
	version = "2.3.0",
	url = ""
}
...
{
	CategoryId category_id = Shop_RegisterCategory(CATEGORY, "CT | Player Models", "");

	char _buffer[PLATFORM_MAX_PATH];
	Shop_GetCfgFile(_buffer, sizeof(_buffer), "ct_player_models.txt");
