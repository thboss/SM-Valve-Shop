...
{
		if (!g_bListenChat[client] && !g_bTransfer[client])
		{
		...
		if(g_bTransfer[client])
		{
			CreateVerificationCredits(client);
		}
		else Functions_ShowPanel(client);
